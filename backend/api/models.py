...
def construct_deal(NS_min=0):
    ...
    while deal.north.hcp + deal.south.hcp < NS_min:
        random.shuffle(l)
        hand_string = ''.join(l)
        deal = parse_deal(hand_string)
...
class BridgeTableManager(models.Manager):
    ...
    def create_deal(self, robot=False, NS_min=0):
